...
// MockLocalDiskManager is a mock of LocalDiskManager interface.
type MockLocalDiskManager struct {
	ctrl     *gomock.Controller
	recorder *MockLocalDiskManagerMockRecorder
}

// MockLocalDiskManagerMockRecorder is the mock recorder for MockLocalDiskManager.
type MockLocalDiskManagerMockRecorder struct {
	mock *MockLocalDiskManager
}

// NewMockLocalDiskManager creates a new mock instance.
func NewMockLocalDiskManager(ctrl *gomock.Controller) *MockLocalDiskManager {
	mock := &MockLocalDiskManager{ctrl: ctrl}
	mock.recorder = &MockLocalDiskManagerMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockLocalDiskManager) EXPECT() *MockLocalDiskManagerMockRecorder {
	return m.recorder
}

// DiscoverAvailableDisks mocks base method.
func (m *MockLocalDiskManager) DiscoverAvailableDisks() ([]*v1alpha1.LocalDisk, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DiscoverAvailableDisks")
	ret0, _ := ret[0].([]*v1alpha1.LocalDisk)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// DiscoverAvailableDisks indicates an expected call of DiscoverAvailableDisks.
func (mr *MockLocalDiskManagerMockRecorder) DiscoverAvailableDisks() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DiscoverAvailableDisks", reflect.TypeOf((*MockLocalDiskManager)(nil).DiscoverAvailableDisks))
}

// GetLocalDisks mocks base method.
func (m *MockLocalDiskManager) GetLocalDisks() (map[string]*v1alpha1.LocalDisk, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetLocalDisks")
	ret0, _ := ret[0].(map[string]*v1alpha1.LocalDisk)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetLocalDisks indicates an expected call of GetLocalDisks.
func (mr *MockLocalDiskManagerMockRecorder) GetLocalDisks() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetLocalDisks", reflect.TypeOf((*MockLocalDiskManager)(nil).GetLocalDisks))
}
...
// MockLocalDeviceListInterface is a mock of LocalDeviceListInterface interface.
type MockLocalDeviceListInterface struct {
	ctrl     *gomock.Controller
	recorder *MockLocalDeviceListInterfaceMockRecorder
}

// MockLocalDeviceListInterfaceMockRecorder is the mock recorder for MockLocalDeviceListInterface.
type MockLocalDeviceListInterfaceMockRecorder struct {
	mock *MockLocalDeviceListInterface
}

// NewMockLocalDeviceListInterface creates a new mock instance.
func NewMockLocalDeviceListInterface(ctrl *gomock.Controller) *MockLocalDeviceListInterface {
	mock := &MockLocalDeviceListInterface{ctrl: ctrl}
	mock.recorder = &MockLocalDeviceListInterfaceMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockLocalDeviceListInterface) EXPECT() *MockLocalDeviceListInterfaceMockRecorder {
	return m.recorder
}

// GetDevicesInfo mocks base method.
func (m *MockLocalDeviceListInterface) GetDevicesInfo(arg0 string, arg1 map[string]struct{}) map[string]*storage.DeviceInfo {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetDevicesInfo", arg0, arg1)
	ret0, _ := ret[0].(map[string]*storage.DeviceInfo)
	return ret0
}

// GetDevicesInfo indicates an expected call of GetDevicesInfo.
func (mr *MockLocalDeviceListInterfaceMockRecorder) GetDevicesInfo(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetDevicesInfo", reflect.TypeOf((*MockLocalDeviceListInterface)(nil).GetDevicesInfo), arg0, arg1)
}
