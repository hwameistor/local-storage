...
func (m *MockControllerManager) ReconcileVolumeGroup(vol *v1alpha1.LocalVolumeGroup) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "ReconcileVolumeGroup", vol)
}

// ReconcileVolumeGroup indicates an expected call of ReconcileVolumeGroup.
func (mr *MockControllerManagerMockRecorder) ReconcileVolumeGroup(vol interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ReconcileVolumeGroup", reflect.TypeOf((*MockControllerManager)(nil).ReconcileVolumeGroup), vol)
}
